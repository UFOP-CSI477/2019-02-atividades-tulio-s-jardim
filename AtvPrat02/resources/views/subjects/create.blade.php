...
@section('content')
    @include('protocols.partials.header', ['title' => __('Criar Assunto')])   
                        ...
                        <form method="post" action="{{ route('subjects.store') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('price') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" step="0.01" name="price" id="input-price" class="form-control form-control-alternative{{ $errors->has('price') ? ' is-invalid' : '' }}" value="{{ old('price') }}" required>
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-success mt-4">{{ __('Criar Assunto') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
